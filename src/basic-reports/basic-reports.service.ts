...
import { getEmploymentLetterByIdReport, getEmploymentLetterReport, getHelloWorldReport, getCountriesReport } from 'src/reports';
...
export class BasicReportsService extends PrismaClient implements OnModuleInit {
    ...
    async getCountryReport() {
        ...
        const doc = await this.printService.createPdf(docDefinition);
        return doc;
    }
